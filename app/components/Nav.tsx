    ...
    <nav style={{ backgroundColor: '#111', borderBottom: '1px solid #2a2a2a', padding: '0.75rem 1rem 0.75rem clamp(0.5rem, 2vw, 1.5rem)', position: 'relative', zIndex: 100 }}>
      ...
      {menuOpen && (
        <div className="mobile-menu" style={{ display: 'none', flexDirection: 'column', gap: '0', paddingTop: '1rem', borderTop: '1px solid #2a2a2a', marginTop: '0.75rem', paddingLeft: '0.5rem' }}>
          ...
          <Link href="/guides" onClick={() => setMenuOpen(false)} style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.875rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#EAD7C5', textDecoration: 'none', padding: '0.875rem 0', borderBottom: '1px solid #2a2a2a' }}>
            Guides
          </Link>
          <Link href="/base-recipes" onClick={() => setMenuOpen(false)} style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.875rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: '#EAD7C5', textDecoration: 'none', padding: '0.875rem 0' }}>
            Base Recipes
          </Link>
        </div>
      )}
