...
export default function HeatZones() {
  return (
    <section style={{ backgroundColor: '#1F1F1F', padding: '4rem 2rem' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        >
          ...
          {/* Direct zone label */}
          <rect x="96" y="80" width="228" height="54" rx="6" fill="#E85C2B" opacity="0.1"/>
          ...
          <text x="210" y="148" textAnchor="middle" fontFamily="Oswald, sans-serif" fontSize="20" fill="#E85C2B" opacity="0.8">~250°C</text>

          {/* ── INDIRECT HEAT ZONE (right) ── */}
          ...
          {/* Indirect zone label */}
          <rect x="352" y="80" width="228" height="54" rx="6" fill="#EAD7C5" opacity="0.07"/>
          ...
          {/* Airflow arrow — low left to high right */}
